    ...
    <section className='site-header' id='header'>
      <div className='home' id='home'>
        ...
        <div className='navigation flex-col'>
          ...
          <p className='link-info'>
            <span>Some </span>
            <NavLink to='/#tutorial' className='site-link'>
              Tutorials
            </NavLink>
            <span> for you</span>
          </p>
          ...
          <p className='link-info'>
            ...
            <NavLink to='/#contact' className='site-link'>
              Contact
            </NavLink>
            <span> me</span>
          </p>
        ...
        <div className='social-links auto-center margin-top-sm'>
          ...
          <a
            href={"https://www.linkedin.com/in/david-rogers-122bb04/"}
            target='_blank'
            rel='noreferrer'
          >
