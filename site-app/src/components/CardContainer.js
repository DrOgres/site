                        ...
                        <div className={"card-content flex-row space-between"}>
                            <div className="card-summary">
                                ...
                                <p className="tag-cloud flex-row wrap">
                                    {data.tags.map((tag) =>
                                        <>
                                            <span className="tag" key={data._id + tag} value={data._id + tag}>{tag}</span>
                                        </>
                                    )} </p>
                                ...
                                {data.page != null &&
                                    ...
                                    <div className="card-cta"><Link to={'pages/' + data.page}>more<i className="fa-solid fa-angles-right"></i></Link></div>
                                }
